...
Constants
---------
 - `qdmpy.shared.fourier.MAG_UNIT_CONV`
 - `qdmpy.shared.fourier.MU_0`
"""
...
__pdoc__ = {
    "qdmpy.shared.fourier.unpad_image": True,
    "qdmpy.shared.fourier.pad_image": True,
    "qdmpy.shared.fourier.define_k_vectors": True,
    "qdmpy.shared.fourier.set_naninf_to_zero": True,
