...
Functions
---------
 - `qdmpy.shared.itool.mask_polygons`
 - `qdmpy.shared.itool.get_im_filtered`
 - `qdmpy.shared.itool._get_im_filtered_gaussian`
 - `qdmpy.shared.itool._zero_background`
 - `qdmpy.shared.itool._equation_plane`
 - `qdmpy.shared.itool._points_to_params`
 - `qdmpy.shared.itool._three_point_background`
 - `qdmpy.shared.itool._mean_background`
...
__pdoc__ = {
    "qdmpy.shared.itool.mask_polygons": True,
    "qdmpy.shared.itool.get_im_filtered": True,
    "qdmpy.shared.itool._get_im_filtered_gaussian": True,
    "qdmpy.shared.itool._zero_background": True,
    "qdmpy.shared.itool._equation_plane": True,
    "qdmpy.shared.itool._points_to_params": True,
    "qdmpy.shared.itool._three_point_background": True,
    "qdmpy.shared.itool._mean_background": True,
    "qdmpy.shared.itool._residual_poly": True,
    "qdmpy.shared.itool._poly_background": True,
    "qdmpy.shared.itool._gaussian": True,
    "qdmpy.shared.itool._moments": True,
    "qdmpy.shared.itool._residual_gaussian": True,
    "qdmpy.shared.itool._gaussian_background": True,
...
def _zero_background(image, zero):
...
def _equation_plane(params, y, x):
...
def _residual_poly(params, y, x, z, order):
    """
...
def _gaussian_background(image):
...
def _interpolated_background(image, interp_method, polygons, sigma):
