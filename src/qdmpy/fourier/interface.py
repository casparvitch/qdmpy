...
---------
 ...
 - `qdmpy.fourier.interface.get_j_from_bxyz_w_src`
    - didn't work
...
__pdoc__ = {
    ...
    # "qdmpy.fourier.interface.get_j_from_bxyz_w_src": True,
...
#     corrections = nv_thickness_correction * qdmpy.fourier._shared.hanning_filter_kspace(
#         k, do_hanning_filter, hanning_low_cutoff, hanning_high_cutoff, standoff
#     )

#     fft_jx = qdmpy.fourier._shared.set_naninf_to_zero(corrections * fft_jx)
#     fft_jy = qdmpy.fourier._shared.set_naninf_to_zero(corrections * fft_jy)
