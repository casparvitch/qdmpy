"""
This module contains tools for processing a user options dictionary.

Functions
---------
 - `qdmpy.opt.interface.load_options`
 - `qdmpy.opt.interface.save_options`
 - `qdmpy.opt.interface._add_bias_field`
 - `qdmpy.opt.interface._get_bias_field`
 - `qdmpy.opt.interface._spherical_deg_to_cart`
 - `qdmpy.opt.interface._recursive_dict_update`
 - `qdmpy.opt.interface._define_output_dir`
 - `qdmpy.opt.interface._interpolate_option_str`
 - `qdmpy.opt.interface.load_polygons`
 - `qdmpy.opt.interface.check_option`
 - `qdmpy.opt.interface.check_options`
 - `qdmpy.opt.interface.clean_options`

Classes
-------
 - `qdmpy.opt.interface.OptionsError`
"""
...
__pdoc__ = {
    "qdmpy.opt.interface.load_options": True,
    "qdmpy.opt.interface.save_options": True,
    "qdmpy.opt.interface._add_bias_field": True,
    "qdmpy.opt.interface._get_bias_field": True,
    "qdmpy.opt.interface._spherical_deg_to_cart": True,
    "qdmpy.opt.interface._recursive_dict_update": True,
    "qdmpy.opt.interface._define_output_dir": True,
    "qdmpy.opt.interface._interpolate_option_str": True,
    "qdmpy.opt.interface.load_polygons": True,
    "qdmpy.opt.interface.check_option": True,
    "qdmpy.opt.interface.check_options": True,
    "qdmpy.opt.interface.clean_options": True,
    "qdmpy.opt.interface.OptionsError": True,
}
# ============================================================================
...
def load_polygons(options):
    if options["polygon_nodes_path"]:
        ...
        # FIXME add polyon stuff to shared
        options["polygons"] = [
