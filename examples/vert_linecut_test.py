...
import numpy as np
from qdmpy.shared.linecut import vert_linecut_vs_position, bulk_vert_linecut_vs_position
...
if SINGLE:
    ...
    integral_series = bulk_vert_linecut_vs_position(
        image_to_show, images, times, 165, averaging_width=averaging_width, sigma=2
    )
