...
json_output_path = "/home/samsc/ResearchData/test_images/mz_test/polys_mz_comparison_gui.json"
...
sim.plot_magsim_bfield_at_nvs(strict_range=(-0.25, 0.25), projection=unv)  # these return fig, ax
sim.plot_comparison(
