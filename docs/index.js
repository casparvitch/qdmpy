...
"url":22,
"doc":"magnetizations: int/float if the same for all polygons, or an iterable of len(polygon_nodes) unit_vectors: 3-iterable if the same for all polygons (cartesian coords), or an iterable of len(polygon_nodes) each element a 3-iterable",
"func":1
},
{
